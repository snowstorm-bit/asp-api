...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Nov 27, 2022 at 01:50 AM
...
(1, 'Climb 1', 'description', 'traditional', '5.12', NULL, '2022-11-27 01:28:22', '2022-11-27 01:28:22');
...
(1, 'Place 6', 'description', 'steps', 0, 0, 1, '2022-11-27 01:31:11', '2022-11-27 01:31:11');
...
INSERT INTO `place_climbs` (`place_id`, `climb_id`, `created_at`, `updated_at`) VALUES
(1, 1, '2022-11-27 01:31:36', '2022-11-27 01:31:36');
...
(1, 'bob martin', 'm@s.com', '$2b$12$l/3NrGYWfZOngW2x9L9Gh.OEb4i12YNpBFire9o32YNJPsBv9IoJa', 1, '2022-11-27 01:30:59', '2022-11-27 01:30:59');
...
ALTER TABLE `place_climbs`
  ADD CONSTRAINT `place_climbs_ibfk_1` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE,
